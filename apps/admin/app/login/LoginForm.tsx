...
/**
 * Admin sign-in. Same Supabase email-OTP + Google flow as the seller app — the
 * difference is authorization: only ADMIN_EMAILS addresses get past
 * requireAdmin() on the pages. A non-admin can sign in here but sees only the
...
export function LoginForm() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
      ...
      <h1 className="mt-1 text-2xl font-bold">Platform admin sign in</h1>
      ...
      <button
        ...
        disabled={busy}
        className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 font-medium hover:bg-zinc-50 disabled:opacity-50"
      >
