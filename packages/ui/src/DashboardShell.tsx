...
export const SELLER_NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/pay-pages", label: "Payment pages", icon: CreditCard },
      { href: "/orders", label: "Orders", icon: ShoppingBag },
      { href: "/reviews", label: "Reviews", icon: Star },
      { href: "/abandoned", label: "Abandoned checkouts", icon: Clock },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/bookings", label: "1-on-1 bookings", icon: CalendarClock },
      { href: "/workshops", label: "Workshops", icon: Video },
      { href: "/courses", label: "Courses", icon: GraduationCap },
      { href: "/forms", label: "Lead forms", icon: ClipboardList },
  ...
  },
  {
    heading: "Workspace",
    items: [
      { href: "/ai-pages/templates", label: "Templates", icon: LayoutTemplate },
