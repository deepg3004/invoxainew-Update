// Indian GST state codes (the first 2 digits of a GSTIN). Used to derive an
// invoice's "place of supply" and to choose IGST (interstate) vs CGST+SGST
// (intrastate) by comparing the supplier's and recipient's state codes.
